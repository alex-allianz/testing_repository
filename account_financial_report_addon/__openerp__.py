...
##############################################################################
{
    'name': 'Add-on for Common Financial Reports',
    'version': '4.0',
    'category': 'Generic Modules/Reporting',
    'description': """ This module ensures that Balance Sheets generated by the account_financial_report module balance out.""",
